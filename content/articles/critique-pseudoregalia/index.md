...
cover:
    ...
    alt: "Key art de Pseudoregalia" # alt text
...
{{< figure src="images/one.jpg" caption="Certains décors ont de superbes ambiances." >}}
...
{{< figure src="images/two.jpg" caption="Même si les combats sont anecdotiques, les animations des attaques sont quand même très bien réalisées. C'est d'autant plus frustrant." >}}
...
{{< figure src="images/three.jpg" caption="Pas besoin de ray-tracing." >}}
